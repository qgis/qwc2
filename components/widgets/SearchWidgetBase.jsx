...
export default class SearchWidgetBase extends React.Component {
    static propTypes = {
        className: PropTypes.string,
        placeholder: PropTypes.string,
        titleWidget: PropTypes.object,
        itemWidget: PropTypes.object,
    ...
    renderResults = () => {
        const TitleWidget = this.props.titleWidget;
        const ItemWidget = this.props.itemWidget;
        return (
                    ...
                    group.items.map(item => {
                        ...
                        return (
                            <ItemWidget
                                group={group}
                                item={item}
                                onClick={() => this.resultSelected(group, item)}>
                            </ItemWidget>
                        );
                    })];
                }).flat()}
