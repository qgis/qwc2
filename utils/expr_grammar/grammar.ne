...
N -> float                         {% id %}
    ...
    | "overlay_intersects" _ "(" _ P0 _ ")"                             {% function(d) { return window.qwc2ExpressionParserContext.overlayIntersects(d[4]); } %}
    | "overlay_intersects" _ "(" _ P0 _ "," _ dqstring _ ")"            {% function(d) { return window.qwc2ExpressionParserContext.overlayIntersects(d[4], d[8]); } %}
