...
| hiddenTools | `array` | Tools to hide. Available tools: `PointSquare`, `PointStar`, `Circle`, `Ellipse`, `Square`, `Box`, `HandDrawing`, `Transform`, `NumericInput`, `Buffer`, `FeatureLabel`, `Export`. | `[]` |
